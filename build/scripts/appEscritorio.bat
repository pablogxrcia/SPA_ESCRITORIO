...
@rem ##########################################################################
@rem
@rem  appEscritorio startup script for Windows
@rem
@rem ##########################################################################
...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %APP_ESCRITORIO_OPTS%  -classpath "%CLASSPATH%" main.Main %*
...
:fail
rem Set variable APP_ESCRITORIO_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
set EXIT_CODE=%ERRORLEVEL%
if %EXIT_CODE% equ 0 set EXIT_CODE=1
if not ""=="%APP_ESCRITORIO_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
